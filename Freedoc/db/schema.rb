...
ActiveRecord::Schema.define(version: 2021_02_04_153522) do
  ...
  create_table "doc_specialities", force: :cascade do |t|
    t.integer "doctor_id"
    t.integer "specialty_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["doctor_id"], name: "index_doc_specialities_on_doctor_id"
    t.index ["specialty_id"], name: "index_doc_specialities_on_specialty_id"
  end
